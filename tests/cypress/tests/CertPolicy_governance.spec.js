...
describeT('@extended Setup - GRC UI: [P1][Sev1][console] - create a certificate expiring soon', () => {
...
describeT('@extended RHACM4K-2294 - GRC UI: [P1][Sev1][console] - CertificatePolicy governance', () => {
...
describeT('@extended RHACM4K_1205 - GRC UI: [P1][Sev1][console] - CertificatePolicy governance', () => {
...
describeT('@extended GRC UI: [P1][Sev1][console] Cleanup - delete a certificate and an issuer', () => {
